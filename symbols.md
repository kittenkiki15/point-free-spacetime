...
| 記号 | 読み方 | 意味 | Lean | 初出 |
| --- | --- | --- | --- | --- |
| $`□`$ | ボックス、必然 | 様相演算子。位相では内部をとる操作 | | [調査 02](surveys/2026-09-25_02_pointfree-topology-basics.md) |
| $`◇`$ | ダイヤモンド、可能 | 様相演算子。$`¬□¬`$。位相では閉包をとる操作 | | [調査 02](surveys/2026-09-25_02_pointfree-topology-basics.md) |
