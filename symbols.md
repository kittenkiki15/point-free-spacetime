...
| $`J^+(S)`$、$`J^-(S)`$ | S の因果的未来・過去 | $`≼`$ についての上集合・下集合。開錐条件のもとで、開集合 $`U`$ について $`J^±(U) = I^±(U)`$ | | [調査 03](surveys/2026-09-25_03_heunen2024.md) |
...
| $`↟U`$、$`↡U`$ | U の局所的な未来錐・過去錐 | $`⋁ \{V : U ⊴ V\}`$、$`⋁ \{W : W ⊴ U\}`$。時空では $`I^±(U)`$ に等しい | | [調査 03](surveys/2026-09-25_03_heunen2024.md) |
