...
| ideal measurement | 理想測定 | 固有値が結果として出て、射影仮説で状態が更新される測定。Sorkin（1993）は、場の量子論で時空の領域に理想測定を素朴に割り当てると、光より速い信号が送れることを示した（不可能な測定）。 | [第 06 回の調査メモ](surveys/2026-09-26_06_minimal-length-covariance.md) |
