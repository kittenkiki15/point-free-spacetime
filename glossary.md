...
| interpolation (of a relation) | 補間性 | 関係 ◁ について、a ◁ b ならば a ◁ c ◁ b となる c があること。余白付きの包含では「余白を二つに分けられる」ことにあたる。最小の尺度があると破れる。 | [第 05 回の調査メモ](surveys/2026-09-26_05_subordination.md) |
