...
| conjugate operators | 共役な演算子 | ブール代数上の演算子 f、g で、f(a) ∧ b = 0 と a ∧ g(b) = 0 が同値になるもの（Jónsson–Tarski）。時制論理の過去の ◇ と未来の ◇ は共役である。 | [heunen2026 のメモ](surveys/2026-09-25_03_heunen2026.md) |
