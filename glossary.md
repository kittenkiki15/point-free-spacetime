...
| geometric logic | 幾何学的論理 | 有限の論理積と任意の論理和だけを使う論理。有限回の観測で確かめられる命題の論理と解釈できる。フレームはその代数である。 | [基礎の調査メモ](surveys/2026-09-25_02_pointfree-topology-basics.md) |
...
| Kochen–Specker theorem | コッヘン–シュペッカーの定理 | 量子系のすべての観測量に、関数関係を保って矛盾なく値を割り当てることはできない、という定理。トポス的アプローチでは、スペクトル前層に大域切断がないことと同値になる。 | [基礎の調査メモ](surveys/2026-09-25_02_pointfree-topology-basics.md) |
...
| quantale | クォンタール | フレームの交わりを、可換とは限らない積に置き換えた構造。非可換な空間の候補として Mulvey が導入した。線形論理と関係する。 | [基礎の調査メモ](surveys/2026-09-25_02_pointfree-topology-basics.md) |
