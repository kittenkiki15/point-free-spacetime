...
| induced observable | 誘導される観測量 | Fewster–Verch の測定の枠組みで、プローブの観測量の測定を、系の観測量の測定とみなしたもの。プローブの初期状態と結合に依存し、一般にプローブの観測量より鋭くない（観測値のばらつきが大きい）。 | [第 06 回の調査メモ](surveys/2026-09-26_06_minimal-length-covariance.md) |
