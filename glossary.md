...
| domain of dependence | 依存領域 | A が下から覆う最大の領域 D⁺(A)。A の情報だけで決まる領域にあたる。時空では、過去に延長できない因果曲線がすべて A と交わる点の集合として定義されてきた。点なしの依存領域は、曲線による依存領域より真に大きい。 | [heunen2026 のメモ](surveys/2026-09-25_03_heunen2026.md) |
